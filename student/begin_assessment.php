  ...
  <aside class="main-sidebar">
    <section class="sidebar">
     ...
     <ul class="treeview-menu">
           ...
           <li class="active"><a href="begin_assessment.php"><i class="fa fa-circle"></i> Begin Examination</a></li>
          </ul>
        </li>
			  <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Examination Information</li>
      </ol>
    </section>
...
if ($examstate == "locked") {
	...
	<div class="callout callout-warning">
        <h4>Examination is locked!</h4>
        Examination is not active
      </div>';
}else {
		print '
	<div class="callout callout-info">
        <h4>Examination is active!</h4>
        Click'; ?> <a onclick="return confirm('Begin Examination ?');" href="exam.php">here</a><?php print ' to begin the Examination
      </div>';
}
