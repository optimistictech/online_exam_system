...
if(isset($_POST['add_department'])) {
	include '../db_config/connection.php';
		...
		$check= "SELECT * FROM department where department_name='$department'";
		$result = $conn->query($check);
		if ($result->num_rows > 0){
			echo "<script language='javascript'> alert('Department  Already Exit');</script>";
		}
		else{
...
if ($conn->query($sql)){ 
echo "<script language='javascript'> alert('Department $department Successfuly added');</script>";
}
else{
...
?>
         ...
         <form  method="POST">
                ...
                <div class="form-group">
                  <textarea class="form-control" rows="3" name="department" placeholder="Department" required></textarea>
                </div>
            <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-default" name="add_department" id="sendEmail">Add Department
