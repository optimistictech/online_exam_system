...
if(isset($_POST['delete_department'])) {
	...
	$sql= "DELETE FROM department WHERE department_id='$department'";

if ($conn->query($sql)){ 
echo "<script language='javascript'> alert('Department $depart Has Been Sucessfully Deleted');</script>";
}
else{
...
?>
            ...
            <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-default" name="delete_department" id="sendEmail">Delete Department
