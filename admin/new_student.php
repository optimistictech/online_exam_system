...
print '<div class="callout callout-warning">
        <h4>'.$error.'!</h4>
        Matric has been registered by '.$used.' Enter Another Matric Number
      </div>';
}
?>
...
?>
              <form action="new_std.php" method="post">
				...
				<div class="form-group">
                  <input type="text" class="form-control" name="stdno"  placeholder="Student Matric Number" required>

                </div>
				<div class="form-group">
				<label>Department</label>
                 <select  class="form-control" rows="3" name="department_name"  > 
				  <?php
				 include '../db_config/connection.php';
