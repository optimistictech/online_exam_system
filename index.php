...
<?php include("header.php"); ?>
  <center> <h1 Style='font-size:30px;color:#00004A;'> Welcome To The Polytechnic Ibadan Online Examination System</h1></center>
<div class="login-box">
  <div class="login-logo">
   <a>  Online Exam Portal</a>
